package ml.ilei.moneybox.utilities;
...
public class Utility {
    public void createReport(
        ...
        try {
            ...
            for (Map.Entry<String, Float> entry : category.entrySet()) {
                stringBuilder.append(entry.getKey()).append(" ").append(df.format(entry.getValue())).append(" руб.").append("\n");
            }
